...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b5f458, const void *arg_0xb7b5f5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b108c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79ba840), 
int (*key_eq_fn)(void *arg_0xb79bac88, void *arg_0xb79bae00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78899b8, int arg_0xb7889b10);
static double RandomUniform(void );
...
typedef TMilli SmartProjectC$PairTimer$precision_tag;
typedef braceletReading SmartProjectC$FakeSensor$val_t;
typedef TMilli SmartProjectC$InfoTimer$precision_tag;
typedef TMilli SmartProjectC$MissingTimer$precision_tag;
...
typedef braceletReading /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void SmartProjectC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void SmartProjectC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void SmartProjectC$PairTimer$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
static void SmartProjectC$FakeSensor$readDone(error_t result, SmartProjectC$FakeSensor$val_t val);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartProjectC$InfoTimer$fired(void );
#line 83
static void SmartProjectC$MissingTimer$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void SmartProjectC$SplitC$startDone(error_t error);
#line 138
static void SmartProjectC$SplitC$stopDone(error_t error);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
static error_t /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading$runTask(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t SmartProjectC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
SmartProjectC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartProjectC$PairTimer$startPeriodic(uint32_t dt);
#line 78
static void SmartProjectC$PairTimer$stop(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t SmartProjectC$FakeSensor$read(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartProjectC$InfoTimer$startPeriodic(uint32_t dt);
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t SmartProjectC$Ack$requestAck(
#line 53
message_t * msg);
#line 85
static bool SmartProjectC$Ack$wasAcked(
#line 80
message_t * msg);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartProjectC$MissingTimer$startOneShot(uint32_t dt);
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t SmartProjectC$AMPacket$source(
#line 84
message_t * amsg);
#line 78
static am_addr_t SmartProjectC$AMPacket$destination(
#line 74
message_t * amsg);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SmartProjectC$SplitC$start(void );
# 27 "SmartProjectC.nc"
bool SmartProjectC$endedPairing1[1000];
bool SmartProjectC$endedPairing2[1000];
bool SmartProjectC$locked[1000];
message_t SmartProjectC$packet[1000];


static void SmartProjectC$sendPairing(void );
static void SmartProjectC$sendRespPairing(void );
static void SmartProjectC$send_info_message(void );


bool SmartProjectC$sensorRead[1000];
braceletReading SmartProjectC$braceletState[1000];




static inline void SmartProjectC$Boot$booted(void );




static inline void SmartProjectC$SplitC$startDone(error_t err);
#line 63
static inline void SmartProjectC$SplitC$stopDone(error_t err);
...
static void SmartProjectC$sendPairing(void );
#line 97
static inline void SmartProjectC$PairTimer$fired(void );





static inline void SmartProjectC$InfoTimer$fired(void );





static inline void SmartProjectC$MissingTimer$fired(void );
...
static void SmartProjectC$sendRespPairing(void );
#line 142
static void SmartProjectC$AMSend$sendDone(message_t *bufPtr, error_t error);
#line 190
static inline message_t *SmartProjectC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 242
static inline void SmartProjectC$FakeSensor$readDone(error_t result, braceletReading reading);
#line 274
static void SmartProjectC$send_info_message(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading$postTask(void );
# 17 "FakeSensorP.nc"
enum /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$__nesc_unnamed4341 {
#line 17
  FakeSensorP$0$reading = 7U
};
#line 17
typedef int /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$__nesc_sillytask_reading[/*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading];


static inline error_t /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading$runTask(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartProjectC$MissingTimer$startOneShot(uint32_t dt){
#line 73
...
#line 73
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t SmartProjectC$AMPacket$destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
inline static am_addr_t SmartProjectC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 190
{
  ...
  if (SmartProjectC$endedPairing1[sim_node()] == FALSE && SmartProjectC$endedPairing2[sim_node()] == FALSE) {
      pairing_msg_t *recMess = (pairing_msg_t *)payload;

      if (SmartProjectC$endedPairing1[sim_node()] == FALSE && strcmp(recMess->rand_key, "AAAAAAAAAAAAAAAAAAAA") == 0 && (TOS_NODE_ID == 2 || TOS_NODE_ID == 1)) {


          sim_log_debug(167U, "Receive", "Received  a paring message from %hhu with content %s\n", SmartProjectC$AMPacket$source(bufPtr), recMess->rand_key);
          sim_log_debug(168U, "pairingEnd1", "Message for pairing of motes 1,2 received.\n");
          SmartProjectC$sendRespPairing();
        }

      if (SmartProjectC$endedPairing2[sim_node()] == FALSE && strcmp(recMess->rand_key, "BBBBBBBBBBBBBBBBBBBB") == 0 && (TOS_NODE_ID == 4 || TOS_NODE_ID == 3)) {


          sim_log_debug(169U, "Receive", "Received  a paring message from %hhu with content %s\n", SmartProjectC$AMPacket$source(bufPtr), recMess->rand_key);
          sim_log_debug(170U, "pairingEnd2", "Message for pairing of motes 3,4 received.\n");
          SmartProjectC$sendRespPairing();
        }
    }
  else 
...
#line 219
      if (strcmp(recMess->data, "AAAAAAAAAAAAAAAAAAAA") == 0 || strcmp(recMess->data, "BBBBBBBBBBBBBBBBBBBB") == 0) {
          sim_log_debug(171U, "Radio_pack", "message ignored paring already done\n");
          return bufPtr;
        }
      if (SmartProjectC$AMPacket$destination(bufPtr) == TOS_NODE_ID) {
          sim_log_debug(172U, "Radio_pack", "INFO message received\n");
          sim_log_debug(173U, "Info", "Position X: %hhu, Y: %hhu\n", __nesc_ntoh_uint16(recMess->X.nxdata), __nesc_ntoh_uint16(recMess->Y.nxdata));
          sim_log_debug(174U, "Info", "Sensor status: %s\n\n", recMess->data);
          SmartProjectC$braceletState[sim_node()].X = __nesc_ntoh_uint16(recMess->X.nxdata);
          SmartProjectC$braceletState[sim_node()].Y = __nesc_ntoh_uint16(recMess->Y.nxdata);
          SmartProjectC$MissingTimer$startOneShot(60000);


          if (strcmp(recMess->data, "FALLING") == 0) {
              sim_log_debug(175U, "Info", "ALERT: FALLING!\n\n\n");
            }
        }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb762bac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb762bac8) {
#line 78
    case 6:
#line 78
      __nesc_result = SmartProjectC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb762bac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * SmartProjectC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t SmartProjectC$Ack$requestAck(message_t * msg){
#line 59
...
#line 59
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SmartProjectC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb749f0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb749f0a0, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb762b108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb762b108, msg, error);
#line 110
}
#line 110
...
inline static bool SmartProjectC$Ack$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
inline static void SmartProjectC$PairTimer$stop(void ){
#line 78
...
#line 53
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartProjectC$InfoTimer$startPeriodic(uint32_t dt){
#line 64
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7629178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7629178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SmartProjectC$SplitC$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartProjectC$PairTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 49
{
  if (err == SUCCESS) {
      ...
      sim_log_debug(148U, "Pairing", "Pairing timer is now on\n");

      SmartProjectC$PairTimer$startPeriodic(1000);

      SmartProjectC$sendPairing();
    }
  else {
      SmartProjectC$SplitC$start();
    }
}
...
#line 113
  SmartProjectC$SplitC$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 63
{
  sim_log_debug(149U, "boot", "The process stopped.\n");
}
...
#line 138
  SmartProjectC$SplitC$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SmartProjectC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74a06a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74a06a8) {
#line 100
    case 0U:
#line 100
      /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74a06a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 242 "SmartProjectC.nc"
static inline void SmartProjectC$FakeSensor$readDone(error_t result, braceletReading reading)
#line 242
{
  SmartProjectC$braceletState[sim_node()] = reading;
  sim_log_debug(176U, "Sensors", "The state of the bracelet is: %s\n", reading.action);

  if (SmartProjectC$sensorRead[sim_node()] == FALSE) {

      SmartProjectC$sensorRead[sim_node()] = TRUE;
    }
  else 
#line 249
    {
      SmartProjectC$sensorRead[sim_node()] = FALSE;
      SmartProjectC$send_info_message();
    }


  sim_log_debug(177U, "Sensors", "Position X: %hhu, Y: %hhu\n", reading.X, reading.Y);
...
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  SmartProjectC$FakeSensor$readDone(result, val);
#line 63
}
#line 63
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 26
{
  ...
  int random_number = /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16() % 10;

#line 29
  bracialetStatus.X = /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  bracialetStatus.Y = /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
...
#line 43
  /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, bracialetStatus);
}
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77e5650){
#line 75
  switch (arg_0xb77e5650) {
#line 75
...
#line 75
      break;
#line 75
    case /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading:
#line 75
      /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading$runTask();
#line 75
      break;
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77e5650);
#line 75
      break;
#line 75
    }
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(/*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading);
#line 67
...
#line 20
{
  /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$reading$postTask();
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t SmartProjectC$FakeSensor$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*SmartProjectAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
#line 103
{
  sim_log_debug(154U, "InfoTimer", "InfoTimer: timer fired at time %s\n", sim_time_string());
  SmartProjectC$FakeSensor$read();
}
...
#line 109
{
  sim_log_debug(155U, "MissingTimer", "\n\n\nMissingTimer: timer fired at time %s\n", sim_time_string());
  sim_log_debug(156U, "Info", "ALERT: MISSING\n");
  sim_log_debug(157U, "Info", "Last known location: %hhu, Y: %hhu\n\n", SmartProjectC$braceletState[sim_node()].X, SmartProjectC$braceletState[sim_node()].Y);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb731f3a8){
#line 83
  switch (arg_0xb731f3a8) {
#line 83
    case 0U:
#line 83
      SmartProjectC$PairTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      SmartProjectC$InfoTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      SmartProjectC$MissingTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb731f3a8);
#line 83
      break;
#line 83
    }
...
#line 118
{
  ...
  pairing_msg_t *pairRespMessage = (pairing_msg_t *)SmartProjectC$Packet$getPayload(&SmartProjectC$packet[sim_node()], sizeof(pairing_msg_t ));

  SmartProjectC$Ack$requestAck(&SmartProjectC$packet[sim_node()]);


  if ((TOS_NODE_ID == 2 || TOS_NODE_ID == 1) && SmartProjectC$locked[sim_node()] == FALSE) {
      if (SmartProjectC$AMSend$send(TOS_NODE_ID % 2 + 1, &SmartProjectC$packet[sim_node()], sizeof(pairing_msg_t )) == SUCCESS) {

          SmartProjectC$locked[sim_node()] = TRUE;
        }
    }
  else {
#line 132
    if ((TOS_NODE_ID == 4 || TOS_NODE_ID == 3) && SmartProjectC$locked[sim_node()] == FALSE) {
        if (SmartProjectC$AMSend$send(TOS_NODE_ID % 2 + 3, &SmartProjectC$packet[sim_node()], sizeof(pairing_msg_t )) == SUCCESS) {
...
#line 55
{
  /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*SmartProjectAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 142
{
  if (&SmartProjectC$packet[sim_node()] == bufPtr && error == SUCCESS) {
      sim_log_debug(158U, "Sent", "Packet sent\n");
      SmartProjectC$locked[sim_node()] = FALSE;

      if (SmartProjectC$endedPairing1[sim_node()] == FALSE && SmartProjectC$Ack$wasAcked(bufPtr) && (SmartProjectC$AMPacket$source(bufPtr) == 1 || SmartProjectC$AMPacket$source(bufPtr) == 2)) {

          if (TOS_NODE_ID == 1 || TOS_NODE_ID == 2) {
              SmartProjectC$PairTimer$stop();
              SmartProjectC$endedPairing1[sim_node()] = TRUE;
              sim_log_debug(159U, "PairingCompleted", "endend paring 1 now true\n");
              sim_log_debug(160U, "PairingCompleted", "Pairing 1/2 completed.\n\n");
            }

          if (TOS_NODE_ID % 2 == 0) {

              sim_log_debug(161U, "OperationalMode", "We start the parent bracelet missing timer\n");
              SmartProjectC$MissingTimer$startOneShot(60000);
            }
          else 
#line 160
            {
              ...
              sim_log_debug(162U, "OperationalMode", "We start the child bracelet info timer\n");
              SmartProjectC$InfoTimer$startPeriodic(10000);
            }
        }

      if (SmartProjectC$endedPairing2[sim_node()] == FALSE && SmartProjectC$Ack$wasAcked(bufPtr) && (SmartProjectC$AMPacket$source(bufPtr) == 3 || SmartProjectC$AMPacket$source(bufPtr) == 4)) {

          if (TOS_NODE_ID == 3 || TOS_NODE_ID == 4) {
              SmartProjectC$PairTimer$stop();
              SmartProjectC$endedPairing2[sim_node()] = TRUE;
              sim_log_debug(163U, "PairingCompleted", "endend paring 2 now true\n");
              sim_log_debug(164U, "PairingCompleted", "Pairing 3/4 completed.\n\n");
            }

          if (TOS_NODE_ID % 2 == 0) {

              sim_log_debug(165U, "OperationalMode", "We start the parent bracelet missing timer\n");
              SmartProjectC$MissingTimer$startOneShot(60000);
            }
          else {
#line 180
            if (TOS_NODE_ID % 2 == 1) {
                ...
                sim_log_debug(166U, "OperationalMode", "We start the child bracelet info timer\n");
                SmartProjectC$InfoTimer$startPeriodic(10000);
              }
            }
        }
...
# 274 "SmartProjectC.nc"
static void SmartProjectC$send_info_message(void )
#line 274
{

  if (SmartProjectC$locked[sim_node()] == FALSE) {
      info_message *message = (info_message *)SmartProjectC$Packet$getPayload(&SmartProjectC$packet[sim_node()], sizeof(info_message ));

      __nesc_hton_uint16(message->X.nxdata, SmartProjectC$braceletState[sim_node()].X);
      __nesc_hton_uint16(message->Y.nxdata, SmartProjectC$braceletState[sim_node()].Y);
      strcpy(message->data, SmartProjectC$braceletState[sim_node()].action);
      SmartProjectC$Ack$requestAck(&SmartProjectC$packet[sim_node()]);

      if (TOS_NODE_ID == 1 && SmartProjectC$locked[sim_node()] == FALSE) {

          if (SmartProjectC$AMSend$send(2, &SmartProjectC$packet[sim_node()], sizeof message) == SUCCESS) {
              sim_log_debug(178U, "Radio", "Radio: sending INFO packet to node %d\n", 2);
              SmartProjectC$locked[sim_node()] = TRUE;
            }
        }
      else {
#line 291
        if (TOS_NODE_ID == 3 && SmartProjectC$locked[sim_node()] == FALSE) {

            if (SmartProjectC$AMSend$send(4, &SmartProjectC$packet[sim_node()], sizeof message) == SUCCESS) {
                sim_log_debug(179U, "Radio", "Radio: sending INFO packet to node %d\n", 4);
                SmartProjectC$locked[sim_node()] = TRUE;
              }
          }
        }
...
#line 68
{
  ...
  if (SmartProjectC$endedPairing1[sim_node()] == FALSE && (TOS_NODE_ID == 1 || TOS_NODE_ID == 2)) {
      sim_log_debug(150U, "PairingSent1", "PairingSent: pairing message for first couple sent at time %s\n", sim_time_string());
      if (SmartProjectC$locked[sim_node()] == FALSE) {
          pairing_msg_t *pairing_msg = (pairing_msg_t *)SmartProjectC$Packet$getPayload(&SmartProjectC$packet[sim_node()], sizeof(pairing_msg_t ));

#line 74
          strcpy(pairing_msg->rand_key, "AAAAAAAAAAAAAAAAAAAA");

          if (SmartProjectC$AMSend$send(AM_BROADCAST_ADDR, &SmartProjectC$packet[sim_node()], sizeof(pairing_msg_t )) == SUCCESS) {
    ...
    if (SmartProjectC$endedPairing2[sim_node()] == FALSE && (TOS_NODE_ID == 3 || TOS_NODE_ID == 4)) {
        sim_log_debug(152U, "PairingSent2", "PairingSent: pairing message for second couple sent at time %s\n", sim_time_string());
        if (SmartProjectC$locked[sim_node()] == FALSE) {
            pairing_msg_t *pairing_msg = (pairing_msg_t *)SmartProjectC$Packet$getPayload(&SmartProjectC$packet[sim_node()], sizeof(pairing_msg_t ));
...
#line 87
            ...
            if (SmartProjectC$AMSend$send(AM_BROADCAST_ADDR, &SmartProjectC$packet[sim_node()], sizeof(pairing_msg_t )) == SUCCESS) {
                sim_log_debug(153U, "Radio", "Radio: sending pairing packet, key=%s\n", "BBBBBBBBBBBBBBBBBBBB");
                SmartProjectC$locked[sim_node()] = TRUE;
              }
          }
      }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SmartProjectC$endedPairing1"))
  {
    *addr = (uintptr_t)&SmartProjectC$endedPairing1[__nesc_mote];
    *size = sizeof(SmartProjectC$endedPairing1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartProjectC$endedPairing2"))
  {
    *addr = (uintptr_t)&SmartProjectC$endedPairing2[__nesc_mote];
    *size = sizeof(SmartProjectC$endedPairing2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartProjectC$locked"))
  {
    *addr = (uintptr_t)&SmartProjectC$locked[__nesc_mote];
    *size = sizeof(SmartProjectC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartProjectC$packet"))
  {
    *addr = (uintptr_t)&SmartProjectC$packet[__nesc_mote];
    *size = sizeof(SmartProjectC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartProjectC$sensorRead"))
  {
    *addr = (uintptr_t)&SmartProjectC$sensorRead[__nesc_mote];
    *size = sizeof(SmartProjectC$sensorRead[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartProjectC$braceletState"))
  {
    *addr = (uintptr_t)&SmartProjectC$braceletState[__nesc_mote];
    *size = sizeof(SmartProjectC$braceletState[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SmartProjectC */
  SmartProjectC$endedPairing1[__nesc_mote] = FALSE;
  SmartProjectC$endedPairing2[__nesc_mote] = FALSE;
  SmartProjectC$locked[__nesc_mote] = FALSE;
  memset((void *)&SmartProjectC$packet[__nesc_mote], 0, sizeof SmartProjectC$packet[__nesc_mote]);
  SmartProjectC$sensorRead[__nesc_mote] = FALSE;
  memset((void *)&SmartProjectC$braceletState[__nesc_mote], 0, sizeof SmartProjectC$braceletState[__nesc_mote]);
